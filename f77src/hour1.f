...
8990  CONTINUE
      ...
      SUBROUTINE reset_soil_acculators
C
C     RESET SOIL ACCUMULATORS
C
      VOLWSO=0.0
      ...
      TBALN=0.0
      TBALP=0.0
      END SUBROUTINE reset_soil_acculators

C-------------------------------------------------------------------
      SUBROUTINE set_gas_mixing_ratios
C
C     CONCENTRATIONS OF CO2, CH4, O2, N2, N2O, NH3, H2 IN ATMOSPHERE
C     AND PRECIPITATION FROM MIXING RATIOS READ IN 'READS'
...
9140  CONTINUE
9145  CONTINUE
      end SUBROUTINE set_gas_mixing_ratios      
